...
<rapid:override name="content">
    <div class="container">
        ...
        <form class="form-register" id="form-register" action="/join" method="post">
            <h2 class="form-register-heading">欢迎注册MicroBlog</h2>
                <%--表单錯誤回显--%>
            ...
            <input type="text" id="input_nickname" name="username" class="form-control" placeholder="用户名" maxlength="20"
                   required
                    >
            <label for="input_email" class="sr-only">Email address</label>
            <input type="email" id="input_email" name="email" class="form-control" placeholder="邮箱地址" required autofocus
                   maxlength="40">
